...
import {
  ...
  messageData,
  newMessageInput,
} from "../application/dtos/chat/chatInfo.dto.schema";
...
export const registerChatDocs = (registry: OpenAPIRegistry) => {
  registry.registerPath({
    ...
    description:
      "Retrieve detailed information about a specific chat including messages, participants, and group details",
    tags: ["Chats"],
    request: {
      params: z.object({
          ...
          "application/json": {
            schema: z
              .object({
                error: z
                  .string()
                  .openapi({ description: "Chat ID is required" }),
              })
  ...
  registry.registerPath({
      ...
      query: z
        .object({
          ...
          lastMessageTimestamp: z
            ...
            .openapi({
              description:
                "Timestamp of the last message received (for pagination)",
            }),
        })
        .partial(),
    },
    responses: {
      ...
      400: {
        description:
          "Bad request - ChatID and lastMessageTimestamp are required",
        content: {
          "application/json": {
            schema: z
              .object({
                error: z
                  ...
                  .openapi({
                    description:
                      "Chat ID and lastMessage timestamp are required",
                  }),
              })
              .openapi("ChatErrorResponse"),
          },
  ...
  registry.registerPath({
    ...
    description:
      "Fetch a list of all chats that a user is involved in, including both direct messages and group chats",
    tags: ["Chats"],
    responses: {
      200: {
          ...
          "application/json": {
            schema: z
              .object({
                error: z
                  .string()
                  .openapi({ description: "User ID is required" }),
              })
              .openapi("ChatErrorResponse"),
          },
        },
    ...
    responses: {
      200: {
        ...
        content: {
          "application/json": {
            schema: z.object({
              unseenMessagesCount: z
                .number()
                .openapi({ description: "Count of unseen messages" }),
            }),
          },
        },
      },
    ...
    request: {
      params: z.object({
        chatId: z
          .string()
          .uuid()
          .openapi({ description: "The ID of the chat to delete" }),
      }),
    },
    responses: {
      200: {
        ...
        content: {
          "application/json": {
            schema: z.object({
              message: z
                .string()
                .openapi({ description: "Chat deleted successfully" }),
            }),
          },
        },
      },
    ...
    request: {
      params: z.object({
        chatId: z
          .string()
          .uuid()
          .openapi({ description: "The ID of the group chat to update" }),
      }),
      body: {
        required: true,
        content: {
            ...
            schema: z
              .object({
                name: z
                  .string()
                  .optional()
                  .openapi({ description: "New name for the group chat" }),
                description: z
                  .string()
                  .optional()
                  .openapi({
                    description: "New description for the group chat",
                  }),
                photo: z
                  .string()
                  .url()
                  .optional()
                  .openapi({ description: "New photo URL for the group chat" }),
              })
