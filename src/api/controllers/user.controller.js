...
var user_service_1 = require("../../application/services/user.service");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, userService.getUserProfile(username)];
            case 1:
                user = _a.sent();
                if (!user)
...
var updateUserProfile = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, updatedData, updatedUser, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, userService.updateUserProfile(id, updatedData)];
            case 1:
                updatedUser = _a.sent();
